...
public class CodeViewPanel
{
    ...
    public void update(String arg) {
        if ("Load Code".equals(arg))
        {
            ...
            this.codeBinHex[previousColor].setBackground(Color.YELLOW);
            this.codeText[previousColor].setBackground(Color.YELLOW);
        }
        else if ("Clear".equals(arg))
        {
            ...
            {
                this.codeText[previousColor].setBackground(Color.WHITE);
                this.codeBinHex[previousColor].setBackground(Color.WHITE);
            }
        ...
        previousColor = this.machine.getPC();
